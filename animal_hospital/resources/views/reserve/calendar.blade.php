...
<div class="top_content">
  ...
  <div class="calendar_list_title">
    <p class="current_calendar_day">{{$current_date->year}}年{{$current_date->month}}月</p>
    <form class="next_calendar" method="post" action="{{url('/reserve/next_reserve_date')}}">
      {{ csrf_field() }}
    ...
    @endif
        <td class="calendar_td">
          ...
          @if(array_key_exists($date->format('Y-m-d'),$is_reservation))
            ...
            @elseif($date->day <= $current_date->day)
